...
class rrt(graph):
    ...
    def __init__(self, edge_length):
        graph.__init__(self)
        self.max_edge_length = edge_length
    ...
    def build_graph_from_environment(self, env, width, height):
        ...
        while not is_complete:
            ...
            new_node = self.get_new_node(neighbor, point, env)
    ...
    def get_new_node(self, init_node, point, env):
        node_pos = init_node.get_position()
        if mathutils.distance(node_pos, point) > self.max_edge_length:
            ...
            diff_vector[0] *= self.max_edge_length
            diff_vector[1] *= self.max_edge_length
